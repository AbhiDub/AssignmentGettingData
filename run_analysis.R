## Downloaded the data into a test folder
download.file("http://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip","test")
temp <- tempfile()
...
## Assignment 2 - extract only measurements on mean and standard deviation
...
## Changing the participant names
